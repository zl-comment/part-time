        ...
        <ul class="range-left">
            ...
            <c:forEach items="${occupations}" var="oc">
                <li>
                    ...
                    <span class="con" style="color: #0A95"><a href="OccupationServlet?method=deleteoccupation&&cpyandocid=${oc.cpyandocid}&&companyid=${companyid}">删除&nbsp;&nbsp;</a></span>
                    <span class="con" style="color: red"><a href="OccupationServlet?method=getoccupation&&ocid=${oc.id}">查看</a></span>
                </li>
