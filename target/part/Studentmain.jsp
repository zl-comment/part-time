        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree layui-inline" lay-filter="nav_left">
               <%-- <li class="layui-nav-item layui-nav-itemed">
                ...
                <li class="layui-nav-item"><a href="getStudentInfoById?id=${student.id}" data-id="1" target="iFrm">我的信息</a></li>
                <li class="layui-nav-item"><a href="getStudentResumeById?id=${student.stresumeid}" target="iFrm"  data-id="3">我的简历</a></li>
<%--                <li class="layui-nav-item"><a href="getOccupations?id=${student.id}" target="iFrm" data-id="4">我的兼职记录</a></li>--%>
            </ul>
        </div>
    </div>
<%--
